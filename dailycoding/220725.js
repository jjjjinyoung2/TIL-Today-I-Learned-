//문제 : 정수를 요소로 갖는 배열을 입력받아 다음의 조건을 만족하는 LSCS*를 리턴해야 합니다.
...
//입력 : 인자 1 : arr / number 타입을 요소로 갖는 배열 / arr.length는 60,000 이하 / arr[i]는 -100,000 이상 100,000 이하의 정수
//출력 : number 타입을 리턴해야 합니다.
//주의사항 : 배열의 모든 요소가 음수인 경우도 있습니다.
//Advanced : LSCS를 계산하는 효율적인 알고리즘(O(N))이 존재합니다. 쉽지 않기 때문에 바로 레퍼런스 코드를 보고 이해하는 데 집중하시기 바랍니다.
