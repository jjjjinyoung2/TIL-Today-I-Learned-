//문제 : 아래와 같은 과정을 거쳐 부등호 수(inequalityNumber)를 만들 수 있습니다.
// 최대 9개의 부등호(<, >)가 주어집니다.
...
//입력 : 인자 1 : signs / string 타입의 공백을 사이에 둔 부등호 기호들 / signs.length는 17 이하 (최대 9개의 부등호 기호)
//출력 : number 타입을 리턴해야 합니다.
//주의사항 : 첫 자리가 0인 경우도 부등호 수에 포함되어야 합니다. / 모든 입력에 답은 항상 존재합니다.
