//문제 : 문자열을 입력받아 다음의 조건을 만족하는 LPS*를 찾아 그 길이를 리턴해야 합니다.
...
//입력 : 인자 1 : str / string 타입의 임의의 알파벳 소문자 문자열 ( / str.length는 60,000 이하
//출력 : number 타입을 리턴해야 합니다.
//주의사항 : prefix(접두어)는 문자열의 첫 인덱스부터 시작하는 모든 부분 문자열을 의미합니다.
