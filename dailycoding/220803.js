//문제 : 다음의 조건을 만족하면서 현재의 비밀번호('curPwd')를 새 비밀번호(newPwd)로 변경하는 데 필요한 최소 동작의 수를 리턴해야 합니다.
...
//입력 : 인자 1 : curPwd / number 타입의 1,000 이상 9,999 이하의 자연수
//인자 2 : newPwd / number 타입의 1,000 이상 9,999 이하의 자연수
//출력 : number 타입을 리턴해야 합니다.
//주의사항 : 4자리인 소수는 1,000 이상의 소수를 말합니다.(0011, 0997 등은 제외)
const isPrime = (num) => {
