...
//문제 : 개업 이래로 항상 승승장구하는 '승승장구 치킨집'의 비결은 소스에 있다.
...
//입력 : 인자 1: stuffArr / Number 타입의 재료를 담은 배열
// 요소는 0과 1로만 이루어진 숫자이며, 항상 1로 시작합니다. / 요소는 중복될 수 없습니다.
// 요소의 길이는 20 이하입니다. / 배열의 길이는 2 이상 10 이하입니다.
// ex) [111, 110, 1010, 10, 10110]
// 인자 2: choiceNum / Number 타입의 1 이상 stuffArr 길이 이하의 자연수
// 재료를 선택할 수 있는 수를 뜻합니다.
// ex) 2
//출력 : Number 타입을 반환해야 합니다.
//stuffArr가 [1, 10, 11000, 1111] 이고, choiceNum은 2라면 사용 가능한 재료는 [1, 10, 1111] 입니다.
//조합할 수 있는 경우의 수는 6 가지입니다.
//주의사항 :
